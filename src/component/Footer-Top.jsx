                ...
                <div className="content">
                    <div className="fblock">
                        <div className="newsletter">
                            ...
                            <input className="email" type="text" name="email" placeholder="Enter your email"></input>
                            <button className="but2">Subscribe</button>
                        </div>
                    </div>
                    <div className="fblock">
                        <div>
                            <h2 className="text2"><div className="mob fa fa-phone"></div>Hot Line</h2>
                            <div className="lines">
                    ...
                    <div className="fblock">
                        <h2 className="text2">Payment Options</h2>
